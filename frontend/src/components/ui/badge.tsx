...
// Map shadcn variants → NextUI Chip color + variant
function getChipProps(variant: BadgeVariant = "default") {
  switch (variant) {
    ...
    case "warning":
      return { color: "warning" as const, variant: "flat" as const };
    case "info":
      return { color: "primary" as const, variant: "flat" as const };
    case "success":
      return { color: "success" as const, variant: "flat" as const };
    default:
