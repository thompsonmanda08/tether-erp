...
export default function BackgroundSVGGrid({
  className,
}: {
  className?: string;
}) {
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stopColor="hsl(var(--muted))" stopOpacity="0" />
        ...
        >
          ...
          <stop offset="0.578125" stopColor="hsl(var(--accent))" />
        ...
        >
          <stop stopColor="hsl(var(--secondary))" />
          <stop offset="0.157789" stopColor="hsl(var(--accent))" />
          <stop offset="1" stopColor="hsl(var(--primary))" />
        </radialGradient>
